package com.example.examjavaservlet.dao;
...
public class EmployeeDAO {
    ...
    private static final String INSERT_EMPLOYEE_SQL = "INSERT INTO employees" + "  (name, birthday, address, position, department) VALUES ";
